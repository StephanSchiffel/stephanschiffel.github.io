...
<!--
	similar to chess_like but uses queens as pieces
	works for  queenbattle versions that have (width x) and (height y) exposed in the state
-->

<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">

	<xsl:import href="queensgames_inc.xsl"/>
